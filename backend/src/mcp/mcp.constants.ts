...
export const MCP_SCOPE_MENU_DELETE = 'mcp:menu:delete';
export const MCP_SCOPE_PROVERB_WRITE = 'mcp:proverb:write';
export const MCP_SCOPE_PROVERB_DELETE = 'mcp:proverb:delete';
...
export type McpScope =
  ...
  | typeof MCP_SCOPE_MENU_DELETE
  | typeof MCP_SCOPE_PROVERB_WRITE
  | typeof MCP_SCOPE_PROVERB_DELETE
